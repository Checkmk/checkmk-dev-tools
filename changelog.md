...
## Released
## [2.4.3] - 2026-08-13T08:46:34+02:00
...
[2.4.3]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.4.3

## [2.4.2] - 2026-07-28T13:17:57+02:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.4.2]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.4.2

## [2.4.1] - 2026-07-28T08:46:31+02:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.4.1]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.4.1

## [2.4.0] - 2026-07-27T09:38:48+02:00
...
[2.4.0]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.4.0

## [2.3.0] - 2026-06-01T20:27:53+02:00
<!-- meta = {'type': 'feature', 'scope': ['all'], 'affected': ['all']} -->
...
[2.3.0]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.3.0

## [2.2.0] - 2026-03-25T07:46:56+01:00
<!-- meta = {'type': 'feature', 'scope': ['all'], 'affected': ['all']} -->
...
[2.2.0]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.2.0

## [2.1.4] - 2026-03-20T11:43:32+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.1.4]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.1.4

## [2.1.3] - 2026-03-19T18:05:14+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.1.3]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.1.3

## [2.1.2] - 2026-03-10T14:50:21+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.1.2]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.1.2

## [2.1.1] - 2026-03-02T10:18:17+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.1.1]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.1.1

## [2.1.0] - 2026-02-18T17:08:11+01:00
<!-- meta = {'type': 'feature', 'scope': ['all'], 'affected': ['all']} -->
...
[2.1.0]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.1.0

## [2.0.3] - 2026-02-05T15:04:55+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.0.3]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.0.3

## [2.0.2] - 2026-01-20T15:22:05+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.0.2]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.0.2

## [2.0.1] - 2025-12-03T08:31:41+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[2.0.1]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.0.1

## [2.0.0] - 2025-11-24T14:57:52+01:00
...
[2.0.0]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//2.0.0

## [1.2.1] - 2025-11-13T13:45:45+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
As the underlying problem - our jenkins instance can be overloaded - is not easily resolveable, we remove the connection check at this call site.
Till now, it never gave us any hints.

[1.2.1]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//1.2.1

## [1.2.0] - 2025-11-11T07:41:52+01:00
<!-- meta = {'type': 'feature', 'scope': ['all'], 'affected': ['all']} -->
...
## [1.1.0] - 2025-10-31T11:22:23+01:00
<!-- meta = {'type': 'feature', 'scope': ['all'], 'affected': ['all']} -->
...
## [1.0.4] - 2025-10-29T16:19:15+01:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->

the previously used retry decorator was not async compatible.


[1.0.4]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//1.0.4

## [1.0.3] - 2025-10-24T09:47:39+02:00
...
[1.0.3]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//1.0.3

## [1.0.2] - 2025-10-21T12:35:25+02:00
<!-- meta = {'type': 'bugfix', 'scope': ['all'], 'affected': ['all']} -->
...
[1.0.2]: https://review.lan.tribe29.com/gitweb?p=checkmk_dev_tools.git;a=tag;h=refs/tags//1.0.2
