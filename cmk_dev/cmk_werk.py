...
def load_config() -> None:
    ...
    try:
        ...
        raise RuntimeError(
            "Unable find config file '.werks/config'. See an example config "
            "file in checkmk_dev_tools - docs/examples/werk_config - to know how "
...
def main_new(args: argparse.Namespace) -> None:
    ...
    werk["component"] = input_choice("Component", get_edition_components(werk.get("edition", "")))
